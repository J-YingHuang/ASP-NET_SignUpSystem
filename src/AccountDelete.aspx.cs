...
namespace SignUpSystem
{
    public partial class AccountDelete : System.Web.UI.Page
    {
        ...
        private void LoadTeamByAccount()
        {
            ...
            SqlCommand command;
            SqlDataReader dr;
            string queryCommand = $"SELECT Account.Name AS teamName,Account.Id AS teamid,School.Name AS SchoolName FROM Account LEFT JOIN  School ON Account.SchoolID=School.Id ";
